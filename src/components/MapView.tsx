...
<svg width="30" height="49" viewBox="0 0 30 49" fill="none" xmlns="http://www.w3.org/2000/svg">
  <path d="M15 0C6.71573 0 0 6.71573 0 15C0 26.25 15 49 15 49C15 49 30 26.25 30 15C30 6.71573 23.2843 0 15 0Z" fill="rgb(16, 185, 129)"/>
  <circle cx="15" cy="15" r="10" fill="white"/>
  <text x="15" y="19" font-family="Arial" font-size="11" fill="rgb(16, 185, 129)" font-weight="bold" text-anchor="middle">%count%</text>
</svg>
`;
